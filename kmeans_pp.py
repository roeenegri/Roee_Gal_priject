...
# helper methods
# change the output format to match theirs
    ...
    try:
        ...
        while len(miu_list) < k:
            for i in range(0, num_of_vectors):  # for every vector in the list:
                ...
                for miu in miu_list:  # for every miu in miu list, we check the min. euclidean distance from curr_vector, and update d_list accordingly
        ...
        # CALLING CLUSTERING METHOD FROM HW1 (need to fix memory freeing)
